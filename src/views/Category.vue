<template>
  <div>
    ...
    <main>
      ...
      <span class="custom__input" @click="filterTask = 'DoingTask' " id="AllTasks">
          <input type="radio" :checked="filterTask === 'DoingTask'" name="filter" value="DoingTasks">
          <label>Tasks</label>
        <div class="check"></div>
      </span>
        <span class="custom__input" id="CompletedTask">
          <input type="radio" :checked="filterTask === 'DoneTask' " name="filter" value="CompletedTask">
          <label @click="filterTask = 'DoneTask'">Completed</label>
           <div class="check"></div>
      </span>
      </div>
